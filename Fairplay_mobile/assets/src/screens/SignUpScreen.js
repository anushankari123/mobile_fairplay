...
const SignupScreen = () => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      const response = await fetch('http://10.53.37.95.:8000/users', {  // Update with your local IP address
        method: 'POST',
        headers: {
...
const styles = StyleSheet.create({
    ...
    signupContainer: {
      width: '100%',  // Adjusted width for better form display
      height: '100%',
    ...
    signupButton: {
      ...
      borderRadius: 8,
      height: 50,
      width: '100%',  // Increased width (90% of the container width)
      alignItems: 'center',
      justifyContent: 'center',
      marginTop: 24,
