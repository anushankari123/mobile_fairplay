...
export default function ModulesScreen() {
  ...
  const fetchModuleProgress = async () => {
    try {
      const response = await axios.get(`http://10.53.37.95:8000/module-quizzes/users/${userId}/module-progress`);
  ...
  const handleModulePress = async (module) => {
    ...
    try {
      const postResponse = await axios.post('http://10.53.37.95:8000/module-quizzes', {
      ...
      await axios.patch(`http://10.53.37.95:8000/module-quizzes/${moduleId}/progress`, {
        module_progress: 0
      });
